...
const permissionGroups: Record<string, string[]> = {
  ...
  booking: [
    ...
    'booking.read',
    'booking.cancel',
    'booking.manage', // refund, reassign, etc (admin/host)
  ],
  user: [
    'user.read',
    'user.manage',
  ...
  reels: ['reel.create', 'reel.read', 'reel.update', 'reel.delete'],
  ...
  host: [
    ...
    'host.dashboard.view',
    'host.earnings.view',
    'host.experiences.view',
    'host.experience.view',
    'host.events.view',
    'host.event.view',
    ...
    'host.reviews.view',
    'host.settings.view',
    'host.transactions.view',
    'host.transaction.view',
  ],
};
